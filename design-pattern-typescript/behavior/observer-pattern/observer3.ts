...
/**
 * This pattern suggests, that you have a subject and some observers.
 * Every time you update your subject state, observers get notified about it.
 * This pattern is very handy when you need to tie several objects
 * to each other with abstraction and freedom of implementation.
 * Also, this pattern is a key part of the familiar model-view-controller (MVC)
 * architectural pattern.
 * Strongly used in almost every GUI library.
 */
